...
import { GITHUB, LINKEDIN, EMAIL } from "../data/links";
        ...
        <div className="hero-grid">
          <div style={fadeIn("about", 0)}>
            ...
            <p style={{
              ...
              innovative web and mobile applications. I specialize in developing web applications using Django and cross-platform mobile applications
            ...
            <div className="hero-buttons">
              <a
                ...
                style={{
                  ...
                  fontSize: 16, textDecoration: "none", fontWeight: 500,
                }}
              >
          ...
          {/* Profile card */}
          <div className="hero-profile-wrap" style={{ ...fadeIn("about", 0.2) }}>
            <div className="hero-profile-card" style={{ position: "relative", width: 320, height: 460 }}>
              <div style={{
              ...
              <div
                ...
                style={{
                  ...
                  padding: "8px 14px", fontSize: 14, color: "#fff",
                  fontWeight: 500, whiteSpace: "nowrap", boxShadow: t.shadow,
                }}
              >
